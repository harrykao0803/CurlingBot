...
def main(args=None):
    ...
    while(1):
        ...
        if state == 'robot':
            ...
            temp_result = calculate_score(webcam_img, webcam_params)
            ...
            if round == 1:
                ...
                trajectory_selection = random.randint(0, 8)
                print("trajectory selection:", trajectory_selection)

            trajectory = obtain_trajectory_params(trajectory_selection)
